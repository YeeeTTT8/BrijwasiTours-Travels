    ...
    <footer className="bg-dark text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-heading font-bold text-xl mb-4">TravelEase</h3>
            <p className="text-gray-400 mb-4">Crafting unforgettable travel experiences across Southeast Asia and the Middle East.</p>
          ...
          <div>
            <h4 className="font-heading font-semibold text-lg mb-4">Travel Resources</h4>
            <ul className="space-y-2">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">&copy; {new Date().getFullYear()} TravelEase. All rights reserved.</p>
